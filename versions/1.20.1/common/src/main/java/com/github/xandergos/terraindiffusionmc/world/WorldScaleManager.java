...
public final class WorldScaleManager {
    ...
    public static void initializeForWorld(ServerLevel serverWorld, boolean terrainDiffusionWorld) {
        ...
        WorldScaleSettingsState state = serverWorld.getDataStorage().computeIfAbsent(
                WorldScaleSettingsState::load, WorldScaleSettingsState::createDefault,
                WorldScaleSettingsState.DATA_NAME);
