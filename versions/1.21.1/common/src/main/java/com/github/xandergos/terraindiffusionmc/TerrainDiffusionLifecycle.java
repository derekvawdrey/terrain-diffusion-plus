...
public final class TerrainDiffusionLifecycle {
    ...
    public static final ResourceLocation NOISE_CAVES_ENABLED_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "noise_caves_enabled");
    ...
    public static void onWorldLoad(ServerLevel world) {
        if (world.dimension() == Level.OVERWORLD) {
            ...
            if (terrainDiffusionWorld) {
                ...
                BetterCavesAquiferContext.bind(world);
