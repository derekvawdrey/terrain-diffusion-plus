...
public final class TerrainDiffusionLifecycle {
    ...
    public static final Identifier NOISE_CAVES_ENABLED_ID = Identifier.fromNamespaceAndPath(MOD_ID, "noise_caves_enabled");
    ...
    public static void registerDensityFunctionCodecs(CodecRegistrar<MapCodec<? extends DensityFunction>> registrar) {
        ...
        registrar.register(NOISE_CAVES_ENABLED_ID, NoiseCavesFlagDensityFunction.CODEC);
    }
     ...
     * list here and hands it over as plain strings. Note: this MC version renamed
     * {@code RegistryAccess.registryOrThrow} to {@code lookupOrThrow} (and
     * {@code ResourceLocation} to {@code Identifier}) compared to 1.20.1/1.21.1.
     */
    private static List<String> enumerateBiomeKeys(CommandContext<CommandSourceStack> ctx) {
        ...
        for (Identifier key : biomeRegistry.keySet()) {
